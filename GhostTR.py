...
stderr.writelines(f"""{Gr}
   ...
   / /\ \ | |    |  ___/|  __  | / /\ \   | |    / _ \ / _` |/ _ \ |  __  | | | | '_ \ 
  / ____ \| |____| |    | |  | |/ ____ \  | |___| (_) | (_| |  __/ | |  | | |_| | |_) |
 /_/    \_\______|_|    |_|  |_/_/    \_\  \_____\___/ \__,_|\___| |_|  |_|\__,_|_.__/ 
                                                                                       
                                                                                       


          {Wh}[ + ]  C O D E   B Y  ALPHA CODE HUB  [ + ]  
...
if input_user == '1': #OPSI 1
   ...
   : o    `.        {Wh}|       {Gr}@CODE BY ALPHA CODE HUB      {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
...
""")
    try:
        ...
        print(f" {Wh}[{Ye}!{Wh}] {Ye}Aborted...")

elif input_user == '0':
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}GHOST-TRACK !")
else:
    print(f" {Ye}No Option Selected!") #FALSE
